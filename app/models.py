...
class Product(db.Model):
    ...
    def is_none(self):
        return True if self.keyword is None or self.id is None or self.title is None or self.price is None or self.review is None or self.image_url is None else False 
